...
namespace MoreDecorations.Types.GenerateTypes.RampCornersInverted
{
    [ModLoader.ModManager]
    class FlippedInvertedRampCorners
    {

        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.FlippedInvertedRampCorners")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "flippedinvertedrampcorner";
            ...
            while (i < GenerateTypeConfig.standardList.Length)
            {
                ...
                types.Add(typeName, new ItemTypeRaw(typeName, new JSONNode()
                     .SetAs("categories", new JSONNode(NodeType.Array)
                        ...
                        .AddToArray(new JSONNode("invertedcorner"))
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.flippedinvertedrampcorners")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "flippedinvertedrampcorner";
            var jobType = "FlippedInvertedRampCorner";
