...
namespace MoreDecorations.Types.GenerateTypes.Ramps
{
    ...
    class FlippedRamps
    {
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.flippedramps")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "flippedramp";
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.flippedramps")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "flippedramp";
            var jobType = "FlippedRamp";
