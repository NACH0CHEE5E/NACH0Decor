...
namespace MoreDecorations.Types.GenerateTypes.RampCornersInverted
{
    ...
    class InvertedRampCorners
    {

        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.invertedrampcorners")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "invertedrampcorner";
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.invertedrampcorners")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "invertedrampcorner";
            var jobType = "InvertedRampCorner";
