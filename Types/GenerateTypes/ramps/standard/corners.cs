...
namespace MoreDecorations.Types.GenerateTypes.RampCorners
{
    ...
    class RampCorners
    {
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.rampcorners")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.rampcorners")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "rampcorner";
            var jobType = "RampCorner";
