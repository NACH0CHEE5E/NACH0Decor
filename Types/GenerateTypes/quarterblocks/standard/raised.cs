...
namespace MoreDecorations.Types.GenerateTypes.QuarterBlocks
{
    ...
    class RaisedQuarterblocks
    {

        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.raisedquarterblocks")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "raisedquarterblock";
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.raisedquarterblocks")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "raisedquarterblock";
            var jobType = "RaisedQuarterBlock";
