...
namespace MoreDecorations.Types.GenerateTypes.CornerBlocks
{
    ...
    class CornerBlocks
    {
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.cornerblocks")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "cornerblock";
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.cornerblocks")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "cornerblock";
            var jobType = "CornerBlock";
            var type1Required = "quarterblock";
            var type2Required = "edgeblock";
            ...
            while (i < GenerateTypeConfig.tiledList.Length)
            {
                ...
                var typeName = GenerateTypeConfig.typePrefix + type + "." + currentType;
                var type1RequiredName = GenerateTypeConfig.typePrefix + type1Required + "." + currentType;
                var type2RequiredName = GenerateTypeConfig.typePrefix + type2Required + "." + currentType;
                ...
                recipes.Add(new JSONNode()
                    ...
                    .SetAs("requires", new JSONNode(NodeType.Array)
                        .AddToArray(new JSONNode()
                            .SetAs("amount", 1)
                            .SetAs("type", type1RequiredName)
                        )
                        .AddToArray(new JSONNode()
                            .SetAs("amount", 1)
                            .SetAs("type", type2RequiredName)
                        )
                    )
