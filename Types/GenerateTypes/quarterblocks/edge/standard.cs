...
namespace MoreDecorations.Types.GenerateTypes.EdgeBlocks
{
    ...
    class EdgeBlocks
    {
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.edgeblocks")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.edgeblocks")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "edgeblock";
            var jobType = "EdgeBlock";
            var typeRequired = "quarterblock";
