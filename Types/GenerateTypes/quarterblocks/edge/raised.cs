...
namespace MoreDecorations.Types.GenerateTypes.EdgeBlocks
{
    [ModLoader.ModManager]
    class RaisedEdgeBlocks
    {

        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.raisededgeblocks")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "raisededgeblock";
            ...
            while (i < GenerateTypeConfig.standardList.Length)
            {
                ...
                types.Add(typeName, new ItemTypeRaw(typeName, new JSONNode()
                     .SetAs("categories", new JSONNode(NodeType.Array)
                        ...
                        .AddToArray(new JSONNode("edgeblock"))
                        .AddToArray(new JSONNode("b"))
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.raisededgeblocks")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "raisededgeblock";
            var jobType = "RaisedEdgeBlock";
            var typeRequired = "edgeblock";
